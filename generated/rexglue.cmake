...
if(REXSDK_DIR)
    ...
    if(REXSDK_VERSION)
        ...
        find_package(rexglue 0.7.0 QUIET CONFIG)
    endif()
...
# Codegen target - run 'cmake --build . --target cror_recharged_codegen'
add_custom_target(cror_recharged_codegen
    COMMAND $<TARGET_FILE:rex::rexglue> codegen ${CMAKE_CURRENT_SOURCE_DIR}/cror_recharged_config.toml
    WORKING_DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR}
    COMMENT "Generating recompiled code for cror_recharged"
    VERBATIM
)
