...
if(REXSDK_DIR)
    ...
    if(REXSDK_VERSION)
        ...
        find_package(rexglue 0.3.0 QUIET CONFIG)
    endif()
...
# Codegen target - run 'cmake --build . --target carsror_codegen'
add_custom_target(carsror_codegen
    COMMAND $<TARGET_FILE:rex::rexglue> codegen ${CMAKE_CURRENT_SOURCE_DIR}/carsror_config.toml
    WORKING_DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR}
    COMMENT "Generating recompiled code for carsror"
    VERBATIM
)
